...
# user input
planId_dict = {
    '-6-Vic94GE-s5oiwg57nAsgAFOm6': ['MMH Gov Committee', ['alina.motygullina@mater.org.au'], 16],
    'OIJpgSEPdEmQH8qvRwC63MgADUak': ['SEQ Regional Health Exec', ['alina.motygullina@mater.org.au'], 16],
    }
